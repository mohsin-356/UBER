  ...
  return (
    <div>
      ...
      <div className='flex gap-2 items-center justify-between flex-col'>
        ...
        <Link to='/captain-home/captain-riding' className='w-full mt-5 flex justify-center bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm Ride</Link>

        <button onClick={() => {
          props.setConfirmRidePopupPanel(false);
        }} className='w-full mt-5 bg-black text-white font-semibold p-2 rounded-lg'>Cancel</button>
